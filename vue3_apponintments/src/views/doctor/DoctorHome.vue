  ...
  <div>
    <div style="height: 60px; background-color: #fff; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      ...
      <div style="width: fit-content; padding-right: 10px; display: flex; align-items: center;">
        <el-avatar> <img :src="userData.Doctor.Img " alt="" style="width: 40px; height: 40px"> </el-avatar>
        <span style="margin-left: 5px">姓名:{{ userData.Doctor.Name  }}</span>
      </div>
    </div>
      ...
      <div style="width: 200px; border-right: 1px solid #ddd; min-height: calc(100vh - 60px)">
        ...
        >
          ...
          <el-sub-menu index="4">
            ...
            <el-menu-item index="/doctor/application">
              <span>请假</span>
            </el-menu-item>
            <el-menu-item index="/doctor/shift">
              <span>个人值班</span>
            </el-menu-item>

            <el-menu-item index="/doctor/Information">
              <span>个人信息</span>
            </el-menu-item>
             </el-sub-menu>
